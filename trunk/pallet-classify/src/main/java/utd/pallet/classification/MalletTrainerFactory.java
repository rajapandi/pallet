...
public class MalletTrainerFactory {
    ...
    /**
     * Creates NaiveBayes Trainer, currently creates trainer with default
     * constructor.
     * 
    ...
    /**
     * Creates MaxEntTrainer, currently creates trainer with default
     * constructor.
     * 
    ...
    /**
     * Creates DecisionTreeTrainer, currently creates trainer with default
     * constructor.
     * 
    ...
    @SuppressWarnings("unchecked")
    /*
     * Creates BalancedWinnowTrainer, currently creates trainer with default
     * constructor.
     * 
    ...
    /**
     * Creates MaxEntGETrainer, currently creates trainer with default
     * constructor.
     * 
    ...
    /**
     * Creates RankMaxEntTrainer, currently creates trainer with default
     * constructor.
     * 
    ...
    /**
     * Creates NaiveBayesEMTrainer, currently creates trainer with default
     * constructor.
     * 
    ...
    // Yet to be done
    /*
     * Creates MCMaxEntTrainer, currently creates trainer with default
     * constructor.
     * 
    ...
    // @SuppressWarnings("unchecked")
    /*
     * public static ClassifierTrainer CreateMCMaxEntTrainer () { return new
     * MCMaxEntTrainer (); }
     */
