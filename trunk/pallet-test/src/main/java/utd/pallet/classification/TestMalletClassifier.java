...
public class TestMalletClassifier {
	...
	public static void main (String[] args) {
		...
		/**
		 *  The data is provided with the labels(on the basis of which classification will be done) 
		 *  
		 */
		...
		/**
		 *  Pipes will be added to the pipelist. The data will be converted into Mallet
		 *  instances passing through these pipes  
		 *  
		 */
		...
		/**
		 *  Adds all the instances generated by the iterator to the Instance List. 
		 *  
		 */
		for (int i = 0; i < 3; i++) {
			try {
			 mc.addThruPipe (new ArrayIterator (trainingdata[i][0],trainingdata[i][1][0]));
		...
		/**
		 * The Classifier will be trained with the sample data using Naivebayes algorithm 
		 *  
		 */
		...
		c = mc.classify("Steve Irvin studies kangaroos also, He is not just a herpetologist");
		System.out.println("Class Name - " + c.getLabeling().getBestLabel());		
